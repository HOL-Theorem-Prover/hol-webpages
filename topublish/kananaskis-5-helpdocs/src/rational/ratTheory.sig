...
(*
   ...
   [rat_TY_DEF]  Definition
      ...
      |- ?rep.
           TYPE_DEFINITION (\c. ?r. rat_equiv r r /\ (c = rat_equiv r)) rep
   ...
   [RAT_EQ_ALT]  Theorem
      ...
      |- !r1 r2.
           (r1 = r2) <=>
           (rat_nmr r1 * rat_dnm r2 = rat_nmr r2 * rat_dnm r1)
   ...
   [RAT_MINV_LES]  Theorem
      ...
      |- !r1.
           0 < r1 ==>
           (rat_minv r1 < 0 <=> r1 < 0) /\ (0 < rat_minv r1 <=> 0 < r1)
   ...
   [RAT_SGN_CLAUSES]  Theorem
      ...
      |- !r1.
           ((rat_sgn r1 = -1) <=> r1 < 0) /\
           ((rat_sgn r1 = 0) <=> (r1 = 0)) /\ ((rat_sgn r1 = 1) <=> r1 > 0)
   ...
   [rat_of_num_def]  Theorem
      ...
      |- (0 = rat_0) /\ (&SUC 0 = rat_1) /\
         !n. &SUC (SUC n) = &SUC n + rat_1
   
   [rat_of_num_ind]  Theorem
      
      |- !P.
           P 0 /\ P (SUC 0) /\ (!n. P (SUC n) ==> P (SUC (SUC n))) ==>
           !v. P v
