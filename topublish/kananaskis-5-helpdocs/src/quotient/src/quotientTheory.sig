...
(*
   ...
   [LAMBDA_RSP]  Theorem
      ...
      |- !R1 abs1 rep1.
           ...
           !R2 abs2 rep2.
             QUOTIENT R2 abs2 rep2 ==>
             !f1 f2.
               (R1 ===> R2) f1 f2 ==> (R1 ===> R2) (\x. f1 x) (\y. f2 y)
   ...
   [QUOTIENT_TRANS]  Theorem
      ...
      |- !R abs rep.
           QUOTIENT R abs rep ==> !x y z. R x y /\ R y z ==> R x z
   ...
   [RES_EXISTS_REGULAR]  Theorem
      ...
      |- !P Q R.
           (!x. R x ==> P x ==> Q x) ==> RES_EXISTS R P ==> RES_EXISTS R Q
   ...
   [RES_FORALL_REGULAR]  Theorem
      ...
      |- !P Q R.
           (!x. R x ==> P x ==> Q x) ==> RES_FORALL R P ==> RES_FORALL R Q
