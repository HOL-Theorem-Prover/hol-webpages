...
(*
   ...
   [BAG_CARD_THM]  Theorem
      ...
      |- (BAG_CARD {||} = 0) /\
         !b.
           FINITE_BAG b ==> !e. BAG_CARD (BAG_INSERT e b) = BAG_CARD b + 1
   ...
   [BAG_DELETE_BAG_IN_down]  Theorem
      ...
      |- !b0 b e1 e2.
           BAG_DELETE b0 e1 b /\ e1 <> e2 /\ e2 <: b0 ==> e2 <: b
   ...
   [BAG_GEN_PROD_POSITIVE]  Theorem
      ...
      |- !b.
           FINITE_BAG b ==> (!x. x <: b ==> 0 < x) ==> 0 < BAG_GEN_PROD b 1
   ...
   [BAG_IN_BAG_DIFF_ALL_DISTINCT]  Theorem
      ...
      |- !b1 b2 e.
           BAG_ALL_DISTINCT b1 ==> (e <: b1 - b2 <=> e <: b1 /\ ~(e <: b2))
   ...
   [SET_OF_BAG_DIFF_SUBSET_down]  Theorem
      ...
      |- !b1 b2.
           SET_OF_BAG b1 DIFF SET_OF_BAG b2 SUBSET SET_OF_BAG (b1 - b2)
   ...
   [SET_OF_BAG_MERGE]  Theorem
      ...
      |- !b1 b2.
           SET_OF_BAG (BAG_MERGE b1 b2) = SET_OF_BAG b1 UNION SET_OF_BAG b2
   ...
   [TC_mlt1_UNION2_I]  Theorem
      ...
      |- !b2 b1.
           FINITE_BAG b2 /\ FINITE_BAG b1 /\ b2 <> {||} ==>
           (mlt1 R)^+ b1 (b1 + b2)
