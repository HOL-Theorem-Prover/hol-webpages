...
(*
   ...
   [polynom_case_def]  Definition
      ...
      |- (!f f1 f2 f3 f4 a. polynom_case f f1 f2 f3 f4 (Pvar a) = f a) /\
         (!f f1 f2 f3 f4 a.
            polynom_case f f1 f2 f3 f4 (Pconst a) = f1 a) /\
         (!f f1 f2 f3 f4 a0 a1.
   ...
   [polynom_repfns]  Definition
      
      |- (!a. mk_polynom (dest_polynom a) = a) /\
         !r.
           (\a0'.
              !'polynom' .
                (!a0'.
                   ...
                   (?a.
                      ...
                      'polynom' a) ==>
                   'polynom' a0') ==>
                'polynom' a0') r <=> (dest_polynom (mk_polynom r) = r)
   ...
   [polynom_case_cong]  Theorem
      ...
      |- !M M' f f1 f2 f3 f4.
           ...
           (polynom_case f f1 f2 f3 f4 M =
            polynom_case f' f1' f2' f3' f4' M')
   
   [polynom_distinct]  Theorem
      
      |- (!a' a. Pvar a <> Pconst a') /\
         (!a1 a0 a. Pvar a <> Pplus a0 a1) /\
         (!a1 a0 a. Pvar a <> Pmult a0 a1) /\ (!a' a. Pvar a <> Popp a') /\
         (!a1 a0 a. Pconst a <> Pplus a0 a1) /\
         (!a1 a0 a. Pconst a <> Pmult a0 a1) /\
         (!a' a. Pconst a <> Popp a') /\
         (!a1' a1 a0' a0. Pplus a0 a1 <> Pmult a0' a1') /\
         (!a1 a0 a. Pplus a0 a1 <> Popp a) /\
         !a1 a0 a. Pmult a0 a1 <> Popp a
