...
(*
   ...
   [word_join_v2w_rwt]  Theorem
      ...
      |- ∀v1 v2.
           ...
           if FINITE 𝕌(:α) ∧ FINITE 𝕌(:β) then
             ...
             FAIL word_join bad domain (v2w v1) (v2w v2)
   ...
   [word_ror_v2w]  Theorem
      ...
      |- ∀n v.
           v2w v ⇄ n =
           (let l = fixwidth (dimindex (:α)) v and x = n MOD dimindex (:α)
            in
              v2w (field (x − 1) 0 l ++ field (dimindex (:α) − 1) x l))
