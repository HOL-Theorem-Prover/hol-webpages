...
(*
   ...
   [extreal_add_def]  Theorem
      ...
      |- (Normal x + Normal y = Normal (x + y)) ∧
         (PosInf + NegInf = PosInf) ∧ (PosInf + PosInf = PosInf) ∧
         (PosInf + Normal v7 = PosInf) ∧ (NegInf + PosInf = PosInf) ∧
         (Normal v2 + PosInf = PosInf) ∧ (NegInf + NegInf = NegInf) ∧
         (NegInf + Normal v5 = NegInf) ∧ (Normal v3 + NegInf = NegInf)

   [extreal_add_ind]  Theorem

      |- ∀P.
           (∀x y. P (Normal x) (Normal y)) ∧ P PosInf NegInf ∧
           P PosInf PosInf ∧ (∀v7. P PosInf (Normal v7)) ∧
   ...
   [extreal_le_ind]  Theorem
      ...
      |- ∀P.
           (∀x y. P (Normal x) (Normal y)) ∧ P NegInf NegInf ∧
           P NegInf PosInf ∧ (∀v5. P NegInf (Normal v5)) ∧
           P PosInf PosInf ∧ (∀v2. P (Normal v2) PosInf) ∧
           P PosInf NegInf ∧ (∀v3. P (Normal v3) NegInf) ∧
           (∀v7. P PosInf (Normal v7)) ⇒
           ∀v v1. P v v1
   ...
   [extreal_sub_def]  Theorem
      ...
      |- (Normal x − Normal y = Normal (x − y)) ∧
         (PosInf − NegInf = PosInf) ∧ (PosInf − PosInf = PosInf) ∧
         (PosInf − Normal v7 = PosInf) ∧ (NegInf − PosInf = NegInf) ∧
         (Normal v2 − PosInf = NegInf) ∧ (NegInf − NegInf = PosInf) ∧
         (NegInf − Normal v5 = NegInf) ∧ (Normal v3 − NegInf = PosInf)
