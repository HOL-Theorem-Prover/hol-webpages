...
(*
   ...
   [saturate_sw2sw]  Theorem
      ...
      |- ∀w.
           ...
           if dimindex (:α) ≤ dimindex (:β) then
             sw2sw w
           else if sw2sw INT_MAXw ≤ w then
             INT_MAXw
           else if w ≤ sw2sw INT_MINw then
             INT_MINw
           else
             w2w w
   ...
   [signed_saturate_sub]  Theorem
      ...
      |- ∀a b.
           ...
           if b = INT_MINw then
             if 0w ≤ a then INT_MAXw else a + INT_MINw
           else if dimindex (:α) = 1 then
             a && ¬b
           else
             signed_saturate_add a (-b)
