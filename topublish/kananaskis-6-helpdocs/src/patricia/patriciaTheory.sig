...
(*
         ...
         WFREC (@R. WF R)
           (λBRANCH a.
              ...
              || (v,v2,Branch v20 v21 v22 v23,Branch v62 v63 v64 v65) ->
                   I (Branch v v2 (Branch v20 v21 v22 v23) (Branch v62 v63 v64 v65)))
   ...
   [PEEK_tupled_primitive_def]  Definition
      ...
      |- PEEK_tupled =
         WFREC
           (@R. WF R ∧ ∀p r l k m. R (if BIT m k then l else r,k) (Branch p m l r,k))
           (λPEEK_tupled a.
              case a of
                 (<{}>,k) -> I NONE
                ...
                ∀'ptree' .
                  (∀a0'.
                     ...
                     (∃a0 a1.
                        a0' =
                        (λa0 a1.
                           ind_type$CONSTR (SUC 0) (a0,a1,ARB) (λn. ind_type$BOTTOM))
                          a0 a1) ∨
                     (∃a0 a1 a2 a3.
                        (a0' =
                         (λa0 a1 a2 a3.
                            ind_type$CONSTR (SUC (SUC 0)) (a0,ARB,a1)
                              (ind_type$FCONS a2
                                 (ind_type$FCONS a3 (λn. ind_type$BOTTOM)))) a0 a1 a2
   ...
   [ptree_case_def]  Definition
      ...
      |- (∀v f f1. ptree_case v f f1 <{}> = v) ∧
         ...
         ∀v f f1 a0 a1 a2 a3. ptree_case v f f1 (Branch a0 a1 a2 a3) = f1 a0 a1 a2 a3
   
   [ptree_repfns]  Definition
