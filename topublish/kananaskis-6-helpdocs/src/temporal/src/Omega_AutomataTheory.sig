...
(*
   ...
   [BUECHI_TRANSLATION]  Theorem
      ...
      |- (Phi (NEXT phi) ⇔
         ...
         (Phi (ALWAYS a) ⇔
          ∃q.
            T ∧ (∀t. q t ⇔ a t ∧ q (t + 1)) ∧ (∀t1. ∃t2. a (t1 + t2) ⇒ q (t1 + t2)) ∧
            Phi q) ∧
         (Phi (EVENTUAL a) ⇔
          ∃q.
            T ∧ (∀t. q t ⇔ a t ∨ q (t + 1)) ∧ (∀t1. ∃t2. q (t1 + t2) ⇒ a (t1 + t2)) ∧
            Phi q) ∧
         (Phi (a SUNTIL b) ⇔
          ∃q.
      ...
      |- ((λt0.
         ...
         ∃p1 p2 q.
           ...
           (∀t.
              ...
              Phi_R (i (t + t0),q (t + t0)) ∧ p1 (t + (t0 + 1)) ∧ p2 (t + (t0 + 1)) ∨
   ...
   [CO_BUECHI_SWHEN_CLOSURE]  Theorem
      ...
      |- ((λt0.
             ∃q.
               Phi_I (q t0) ∧ (∀t. Phi_R (i (t + t0),q (t + t0))) ∧
               ∃t1. ∀t2. Psi (i (t1 + (t2 + t0)),q (t1 + (t2 + t0)))) SWHEN phi) t0 ⇔
         ∃p1 p2 q.
           (¬p1 t0 ∧ ¬p2 t0 ∧ (q t0 = c) ∨ p1 t0 ∧ ¬p2 t0 ∧ Phi_I (q t0)) ∧
           (∀t.
              ¬p1 (t + t0) ∧ ¬p2 (t + t0) ∧ (q (t + t0) = c) ∧ ¬phi (t + t0) ∧
   ...
   [TEMP_OPS_DEFS_TO_OMEGA]  Theorem
      ...
      |- ((l = NEXT a) ⇔ T ∧ (∀t. l t ⇔ a (SUC t)) ∧ T) ∧
         ...
         ((l = PSNEXT (PEVENTUAL a)) ⇔ (l 0 ⇔ F) ∧ (∀t. l (SUC t) ⇔ a t ∨ l t) ∧ T) ∧
