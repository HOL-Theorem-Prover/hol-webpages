...
(*
   ...
   [CONJUNCTIVE_NORMAL_FORM]  Theorem
      ...
      |- (NEXT (λt. a t ∧ b t) = (λt. NEXT a t ∧ NEXT b t)) ∧
         ...
         ((λt. a t ∧ b t) PUNTIL c = (λt. (a PUNTIL c) t ∧ (b PUNTIL c) t)) ∧
   ...
   [DISJUNCTIVE_NORMAL_FORM]  Theorem
      ...
      |- (NEXT (λt. a t ∨ b t) = (λt. NEXT a t ∨ NEXT b t)) ∧
         ...
         (PNEXT (λt. a t ∨ b t) = (λt. PNEXT a t ∨ PNEXT b t)) ∧
         (PEVENTUAL (λt. a t ∨ b t) = (λt. PEVENTUAL a t ∨ PEVENTUAL b t)) ∧
         ((λt. a t ∨ b t) PWHEN c = (λt. (a PWHEN c) t ∨ (b PWHEN c) t)) ∧
         ((λt. a t ∨ b t) PSWHEN c = (λt. (a PSWHEN c) t ∨ (b PSWHEN c) t)) ∧
         (a PUNTIL (λt. b t ∨ c t) = (λt. (a PUNTIL b) t ∨ (a PUNTIL c) t)) ∧
   ...
   [IMMEDIATE_EVENT]  Theorem
      ...
      |- b t ⇒
         ...
         ((a PUNTIL b) t ⇔ T) ∧ ((a PBEFORE b) t ⇔ F) ∧ ((b PBEFORE a) t ⇔ ¬a t) ∧
   ...
   [NEGATION_NORMAL_FORM]  Theorem
      ...
      |- (¬NEXT a t ⇔ NEXT (λt. ¬a t) t) ∧ (¬ALWAYS a t ⇔ EVENTUAL (λt. ¬a t) t) ∧
         ...
         (¬PNEXT a t ⇔ PSNEXT (λt. ¬a t) t) ∧ (¬PSNEXT a t ⇔ PNEXT (λt. ¬a t) t) ∧
   ...
   [PNEXT_INWARDS_NORMAL_FORM]  Theorem
      ...
      |- (PNEXT (λt. ¬a t) = (λt. ¬PSNEXT a t)) ∧
         ...
         (PNEXT (PEVENTUAL a) = (λt. InitPoint t ∨ PEVENTUAL (PSNEXT a) t)) ∧
         (PNEXT (a PSUNTIL b) = (λt. InitPoint t ∨ (PNEXT a PSUNTIL PSNEXT b) t)) ∧
         (PNEXT (a PSWHEN b) = (λt. InitPoint t ∨ (PNEXT a PSWHEN PSNEXT b) t)) ∧
         (PNEXT (a PSBEFORE b) = (λt. InitPoint t ∨ (PSNEXT a PSBEFORE PNEXT b) t)) ∧
   ...
   [PRENEX_NEXT_NORMAL_FORM]  Theorem
      ...
      |- (¬NEXT a t ⇔ NEXT (λt. ¬a t) t) ∧
         ...
         (a PSUNTIL NEXT b = NEXT (PNEXT a PSUNTIL (λt. ¬InitPoint t ∧ b t))) ∧
         (a PSWHEN NEXT b = NEXT (PNEXT a PSWHEN (λt. ¬InitPoint t ∧ b t))) ∧
         ...
         (a PBEFORE NEXT b = NEXT (PNEXT a PBEFORE (λt. ¬InitPoint t ∧ b t))) ∧
         (NEXT a PSUNTIL b = NEXT (a PSUNTIL PSNEXT b)) ∧
         (NEXT a PSWHEN b = NEXT (a PSWHEN PSNEXT b)) ∧
         (NEXT a PSBEFORE b = NEXT ((λt. ¬InitPoint t ∧ a t) PSBEFORE PNEXT b)) ∧
         (NEXT a PUNTIL b = NEXT ((λt. InitPoint t ∨ a t) PUNTIL PNEXT b)) ∧
   ...
   [PUNTIL_EXPRESSIVE]  Theorem
      ...
      |- (PALWAYS a = (λt. (a PUNTIL (λt. F)) t)) ∧
         ...
         (a PSWHEN b = (λt. ¬((λt. ¬a t ∨ ¬b t) PUNTIL (λt. ¬a t ∧ b t)) t)) ∧
   ...
   [SEPARATE_BEFORE_THM]  Theorem
      ...
      |- (a BEFORE (λt. b t ∨ c t) = (λt. (a BEFORE b) t ∧ (a BEFORE c) t)) ∧
         ...
         (a BEFORE (λt. b t ∧ PNEXT c t) =
          (λt.
             ¬(b t ∧ PNEXT c t) ∧ (a t ∨ (NEXT a BEFORE (λt. c t ∧ NEXT b t)) t))) ∧
         (a BEFORE (λt. b t ∧ PSNEXT c t) =
          (λt.
             ¬(b t ∧ PSNEXT c t) ∧ (a t ∨ (NEXT a BEFORE (λt. c t ∧ NEXT b t)) t))) ∧
         ...
         ((λt. a t ∧ (b PBEFORE c) t) BEFORE d =
          (λt.
             ...
             ((λt.
                 b t ∧ ¬c t ∧
                 ((λt. ¬d t ∧ ¬NEXT c t) SUNTIL (λt. a t ∧ ¬d t)) t) BEFORE d) t)) ∧
   ...
   [SEPARATE_PNEXT_THM]  Theorem
      ...
      |- (PNEXT (λt. a t ∧ NEXT b t) = (λt. InitPoint t ∨ b t ∧ PNEXT a t)) ∧
         (PNEXT (λt. a t ∧ (b SUNTIL c) t) =
          (λt. PNEXT (λt. a t ∧ c t) t ∨ (b SUNTIL c) t ∧ PNEXT (λt. a t ∧ b t) t)) ∧
         ...
         (PNEXT (λt. a t ∨ (b BEFORE c) t) =
          (λt.
             PNEXT (λt. a t ∨ ¬c t) t ∧ ((b BEFORE c) t ∨ PNEXT (λt. a t ∨ b t) t)))
      ...
      |- (a PSUNTIL (λt. b t ∨ c t) = (λt. (a PSUNTIL b) t ∨ (a PSUNTIL c) t)) ∧
         ...
         (a PSUNTIL (λt. b t ∧ (c SUNTIL d) t) =
          (λt.
             ...
             (a PSUNTIL (λt. d t ∧ ((λt. a t ∧ PNEXT c t) PSUNTIL b) t)) t)) ∧
         (a PSUNTIL (λt. b t ∧ (c BEFORE d) t) =
          (λt.
             (c BEFORE d) t ∧ ((λt. a t ∧ ¬PNEXT d t) PSUNTIL b) t ∨
             (a PSUNTIL (λt. c t ∧ ¬d t ∧ ((λt. a t ∧ ¬PNEXT d t) PSUNTIL b) t))
               t)) ∧
         ((λt. a t ∧ b t) PSUNTIL c = (λt. (a PSUNTIL c) t ∧ (b PSUNTIL c) t)) ∧
         ((λt. a t ∨ NEXT b t) PSUNTIL c =
          (λt.
             c t ∨ (a t ∨ NEXT b t) ∧ ((λt. b t ∨ PNEXT a t) PSUNTIL PSNEXT c) t)) ∧
         ((λt. a t ∨ (b SUNTIL c) t) PSUNTIL d =
          (λt.
             ((b SUNTIL c) t ∨ ((λt. d t ∨ PNEXT c t) PBEFORE (λt. ¬a t ∧ ¬d t)) t) ∧
             ((λt.
                 b t ∨ c t ∨
                 ((λt. d t ∨ PNEXT c t) PBEFORE (λt. ¬a t ∧ ¬d t)) t) PSUNTIL d)
               t)) ∧
         ((λt. a t ∨ (b BEFORE c) t) PSUNTIL d =
          (λt.
             ...
             ((λt.
                 ¬c t ∨ ((λt. d t ∨ PSNEXT b t) PBEFORE (λt. ¬a t ∧ ¬d t)) t) PSUNTIL
              d) t))
   ...
   [SEPARATE_SUNTIL_THM]  Theorem
      ...
      |- (a SUNTIL (λt. b t ∨ c t) = (λt. (a SUNTIL b) t ∨ (a SUNTIL c) t)) ∧
         (a SUNTIL (λt. b t ∧ PNEXT c t) =
          (λt. b t ∧ PNEXT c t ∨ (a SUNTIL (λt. a t ∧ c t ∧ NEXT b t)) t)) ∧
         ...
         ((λt. a t ∨ PNEXT b t) SUNTIL c =
          (λt. c t ∨ (a t ∨ PNEXT b t) ∧ ((λt. b t ∨ NEXT a t) SUNTIL NEXT c) t)) ∧
         ...
         ((λt. a t ∨ (b PSUNTIL c) t) SUNTIL d =
          (λt.
             ...
             ((λt.
                 b t ∨ c t ∨
                 ((λt. d t ∨ NEXT c t) BEFORE (λt. ¬a t ∧ ¬d t)) t) SUNTIL d) t)) ∧
   ...
   [SIMPLIFY]  Theorem
      ...
      |- (NEXT (λt. F) = (λt. F)) ∧ (NEXT (λt. T) = (λt. T)) ∧
         ...
         (a SUNTIL a = a) ∧ ((λt. F) UNTIL b = b) ∧ ((λt. T) UNTIL b = (λt. T)) ∧
         (a UNTIL (λt. F) = ALWAYS a) ∧ (a UNTIL (λt. T) = (λt. T)) ∧
         (a UNTIL a = a) ∧ ((λt. F) SWHEN b = (λt. F)) ∧
         ((λt. T) SWHEN b = EVENTUAL b) ∧ (a SWHEN (λt. F) = (λt. F)) ∧
         (a SWHEN (λt. T) = a) ∧ (a SWHEN a = EVENTUAL a) ∧
         ((λt. F) WHEN b = ALWAYS (λt. ¬b t)) ∧ ((λt. T) WHEN b = (λt. T)) ∧
         (a WHEN (λt. F) = (λt. T)) ∧ (a WHEN (λt. T) = a) ∧ (a WHEN a = (λt. T)) ∧
         ...
         (a PSUNTIL a = a) ∧ ((λt. F) PUNTIL b = b) ∧ ((λt. T) PUNTIL b = (λt. T)) ∧
         (a PUNTIL (λt. F) = PALWAYS a) ∧ (a PUNTIL (λt. T) = (λt. T)) ∧
         (a PUNTIL a = a) ∧ ((λt. F) PSWHEN b = (λt. F)) ∧
         ((λt. T) PSWHEN b = PEVENTUAL b) ∧ (a PSWHEN (λt. F) = (λt. F)) ∧
         (a PSWHEN (λt. T) = a) ∧ (a PSWHEN a = PEVENTUAL a) ∧
         ((λt. F) PWHEN b = PALWAYS (λt. ¬b t)) ∧ ((λt. T) PWHEN b = (λt. T)) ∧
         (a PWHEN (λt. F) = (λt. T)) ∧ (a PWHEN (λt. T) = a) ∧
         (a PWHEN a = (λt. T)) ∧ ((λt. F) PSBEFORE b = (λt. F)) ∧
         ((λt. T) PSBEFORE b = (λt. ¬b t)) ∧ (a PSBEFORE (λt. F) = PEVENTUAL a) ∧
