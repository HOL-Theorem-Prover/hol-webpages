...
(*
   ...
   [real_TY_DEF]  Definition
      ...
      |- ∃rep. TYPE_DEFINITION (λc. ∃r. r treal_eq r ∧ (c = $treal_eq r)) rep
   ...
   [TREAL_ADD_WELLDEF]  Theorem
      ...
      |- ∀x1 x2 y1 y2.
           x1 treal_eq x2 ∧ y1 treal_eq y2 ⇒ x1 treal_add y1 treal_eq x2 treal_add y2
   ...
   [TREAL_LT_MUL]  Theorem
      ...
      |- ∀x y.
           treal_0 treal_lt x ∧ treal_0 treal_lt y ⇒ treal_0 treal_lt x treal_mul y
   ...
   [TREAL_MUL_WELLDEF]  Theorem
      ...
      |- ∀x1 x2 y1 y2.
           x1 treal_eq x2 ∧ y1 treal_eq y2 ⇒ x1 treal_mul y1 treal_eq x2 treal_mul y2
