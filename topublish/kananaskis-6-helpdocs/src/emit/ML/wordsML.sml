...
struct
  nonfix word_to_hex_string word_to_dec_string word_to_oct_string
         ...
         word_to_oct_list word_to_bin_list w2s w2l bit_field_insert
         reduce_nor reduce_nand reduce_xnor reduce_xor reduce_or
         reduce_and word_reduce word_lt word_ls word_lo word_le word_hs
         word_hi word_gt word_ge word_index word_rrx word_rol word_ror
         word_asr word_lsr word_mul word_sub word_add word_sdiv word_div
         word_2comp word_xor word_and word_1comp add_with_carry word_msb
         word_lsb word_modify word_reverse word_log2 word_concat_itself
         word_slice word_extract_itself sw2sw_itself word_join word_bit
         word_signed_bits word_bits word_lsl word_or w2w_itself word_eq
         w2n INT_MAX UINT_MAX INT_MIN fromNum dimword * / div mod + - ^
         @ <> > < >= <= := o before;
