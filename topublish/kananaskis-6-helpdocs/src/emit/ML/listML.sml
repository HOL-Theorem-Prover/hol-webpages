...
struct
  nonfix list_size REV LEN LENGTH EL ALL_DISTINCT FRONT LAST REVERSE
         UNZIP ZIP MAP2 EXISTS EVERY FOLDL FOLDR FILTER MEM MAP FLAT
         APPEND TL HD NULL * / div mod + - ^ @ <> > < >= <= := o before;
