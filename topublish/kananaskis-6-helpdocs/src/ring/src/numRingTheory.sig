...
(*
   ...
   [num_canonical_sum_merge_def]  Definition
      ...
      |- num_canonical_sum_merge = canonical_sum_merge (semi_ring 0 1 $+ mult)
   
   [num_canonical_sum_prod_def]  Definition
      
      |- num_canonical_sum_prod = canonical_sum_prod (semi_ring 0 1 $+ mult)
   
   [num_canonical_sum_scalar2_def]  Definition
      
      |- num_canonical_sum_scalar2 = canonical_sum_scalar2 (semi_ring 0 1 $+ mult)
   
   [num_canonical_sum_scalar3_def]  Definition
      
      |- num_canonical_sum_scalar3 = canonical_sum_scalar3 (semi_ring 0 1 $+ mult)
   
   [num_canonical_sum_scalar_def]  Definition
      
      |- num_canonical_sum_scalar = canonical_sum_scalar (semi_ring 0 1 $+ mult)
   
   [num_canonical_sum_simplify_def]  Definition
      
      |- num_canonical_sum_simplify = canonical_sum_simplify (semi_ring 0 1 $+ mult)
   ...
   [num_spolynom_normalize_def]  Definition
      ...
      |- num_spolynom_normalize = spolynom_normalize (semi_ring 0 1 $+ mult)
   ...
   [num_ring_thms]  Theorem
      ...
      |- is_semi_ring (semi_ring 0 1 $+ mult) ∧
         ...
         ((∀t2 l2 l1 c2 c1.
          ...
          ∀l1 c1. num_monom_insert c1 l1 Nil_monom = Cons_monom c1 l1 Nil_monom) ∧
         ((∀t2 l2 l1 c2.
         ...
         ((∀vm c. num_interp_m vm c [] = c) ∧
          ∀vm c x t. num_interp_m vm c (x::t) = mult c (num_ivl_aux vm x t)) ∧
