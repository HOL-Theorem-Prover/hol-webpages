...
(*
   ...
   [SUBSET_MAX_SET]  Theorem
      ...
      |- ∀I J n. FINITE I ∧ FINITE J ∧ I ≠ ∅ ∧ J ≠ ∅ ∧ I ⊆ J ⇒ MAX_SET I ≤ MAX_SET J
   ...
   [SUM_IMAGE_DELETE]  Theorem
      ...
      |- ∀f s.
           FINITE s ⇒
           ∀e. SIGMA f (s DELETE e) = if e ∈ s then SIGMA f s − f e else SIGMA f s
   
   [SUM_IMAGE_IN_LE]  Theorem
      
      |- ∀f s e. FINITE s ∧ e ∈ s ⇒ f e ≤ SIGMA f s
   ...
   [SUM_IMAGE_SUBSET_LE]  Theorem
      ...
      |- ∀f s t. FINITE s ∧ t ⊆ s ⇒ SIGMA f t ≤ SIGMA f s
   ...
   [SUM_IMAGE_UNION]  Theorem
      ...
      |- ∀f s t.
           FINITE s ∧ FINITE t ⇒
           (SIGMA f (s ∪ t) = SIGMA f s + SIGMA f t − SIGMA f (s ∩ t))
   
   [SUM_IMAGE_lower_bound]  Theorem
      
      |- ∀s. FINITE s ⇒ ∀n. (∀x. x ∈ s ⇒ n ≤ f x) ⇒ CARD s * n ≤ SIGMA f s
   
   [SUM_IMAGE_upper_bound]  Theorem
      
      |- ∀s. FINITE s ⇒ ∀n. (∀x. x ∈ s ⇒ f x ≤ n) ⇒ SIGMA f s ≤ CARD s * n
   ...
   [partition_SUBSET]  Theorem
      ...
      |- ∀R s t. R equiv_on s ∧ t ∈ partition R s ⇒ t ⊆ s
