...
sig
  ...
  (*  Theorems  *)
    ...
    val COUNT_LIST___ADD : thm
    val COUNT_LIST___COUNT : thm
...
(*
   ...
   [BUTFIRSTN_compute]  Theorem
      ...
      |- (∀l. DROP 0 l = l) ∧
         (∀n x l. DROP (NUMERAL (BIT1 n)) (x::l) = DROP (NUMERAL (BIT1 n) − 1) l) ∧
   ...
   [COUNT_LIST_compute]  Theorem
      ...
      |- (COUNT_LIST 0 = []) ∧
         (∀n.
            COUNT_LIST (NUMERAL (BIT1 n)) =
            0::MAP SUC (COUNT_LIST (NUMERAL (BIT1 n) − 1))) ∧
         ∀n.
           COUNT_LIST (NUMERAL (BIT2 n)) = 0::MAP SUC (COUNT_LIST (NUMERAL (BIT1 n)))
   ...
   [FIRSTN_compute]  Theorem
      ...
      |- (∀l. TAKE 0 l = []) ∧
         (∀n x l.
            TAKE (NUMERAL (BIT1 n)) (x::l) = x::TAKE (NUMERAL (BIT1 n) − 1) l) ∧
         ∀n x l. TAKE (NUMERAL (BIT2 n)) (x::l) = x::TAKE (NUMERAL (BIT1 n)) l
   ...
   [GENLIST_compute]  Theorem
      ...
      |- (∀f. GENLIST f 0 = []) ∧
         (∀f n.
            ...
            SNOC (f (NUMERAL (BIT1 n) − 1)) (GENLIST f (NUMERAL (BIT1 n) − 1))) ∧
         ∀f n.
