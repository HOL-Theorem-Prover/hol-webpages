...
(*
   ...
   [NUMERAL_BITWISE]  Theorem
      ...
      |- (∀x f a. BITWISE x f 0 0 = NUMERAL (iBITWISE x f 0 0)) ∧
         (∀x f a. BITWISE x f (NUMERAL a) 0 = NUMERAL (iBITWISE x f (NUMERAL a) 0)) ∧
         (∀x f b. BITWISE x f 0 (NUMERAL b) = NUMERAL (iBITWISE x f 0 (NUMERAL b))) ∧
         ∀x f a b.
   ...
   [NUMERAL_iDIV2]  Theorem
      ...
      |- (iDIV2 ZERO = ZERO) ∧ (iDIV2 (iSUC ZERO) = ZERO) ∧ (iDIV2 (BIT1 n) = n) ∧
         (iDIV2 (iSUC (BIT1 n)) = iSUC n) ∧ (iDIV2 (BIT2 n) = iSUC n) ∧
         (iDIV2 (iSUC (BIT2 n)) = iSUC n) ∧ (NUMERAL (iSUC n) = NUMERAL (SUC n))
