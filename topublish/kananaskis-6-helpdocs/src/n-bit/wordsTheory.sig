...
(*
   ...
   [n2w_itself_primitive_def]  Definition
      ...
      |- n2w_itself =
         WFREC (@R. WF R) (λn2w_itself a. case a of (n,(:α)) -> I (n2w n))
   ...
   [word_join_def]  Definition
      ...
      |- ∀v w.
           word_join v w = (let cv = w2w v and cw = w2w w in cv ≪ dimindex (:β) ‖ cw)
   ...
   [ADD_WITH_CARRY_SUB]  Theorem
      ...
      |- ∀x y.
           ...
           (x − y,y ≤₊ x,(word_msb x ⇎ word_msb y) ∧ (word_msb (x − y) ⇎ word_msb x))
   ...
   [TWO_COMP_NEG]  Theorem
      ...
      |- ∀a.
           word_msb a ⇒
           if (dimindex (:α) − 1 = 0) ∨ (a = INT_MINw) then
             word_msb (-a)
           else
             ¬word_msb (-a)
   ...
   [WORD_OR_CLAUSES]  Theorem
      ...
      |- ∀a.
           (UINT_MAXw ‖ a = UINT_MAXw) ∧ (a ‖ UINT_MAXw = UINT_MAXw) ∧ (0w ‖ a = a) ∧
           (a ‖ 0w = a) ∧ (a ‖ a = a)
   ...
   [sw2sw]  Theorem
      ...
      |- ∀w i.
           i < dimindex (:β) ⇒
           (sw2sw w ' i ⇔
            if i < dimindex (:α) ∨ dimindex (:β) < dimindex (:α) then
              w ' i
            else
              word_msb w)
   ...
   [w2s_s2w]  Theorem
      ...
      |- ∀b s. w2s b n2c (s2w b c2n s) = n2s b n2c (s2n b c2n s MOD dimword (:α))
   ...
   [w2w_LSL]  Theorem
      ...
      |- ∀w n.
           w2w (w ≪ n) =
           if n < dimindex (:α) then w2w ((dimindex (:α) − 1 − n -- 0) w) ≪ n else 0w
