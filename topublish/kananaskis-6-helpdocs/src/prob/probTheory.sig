...
(*
   ...
   [algebra_measure_def]  Definition
      ...
      |- ∀b.
           algebra_measure b =
           inf (λr. ∃c. (algebra_embed b = algebra_embed c) ∧ (alg_measure c = r))
   
   [prob_def]  Definition
      
      |- ∀s. prob s = sup (λr. ∃b. (algebra_measure b = r) ∧ algebra_embed b ⊆ s)
   ...
   [ALGEBRA_MEASURE_MONO_EMBED]  Theorem
      ...
      |- ∀b c.
           algebra_embed b ⊆ algebra_embed c ⇒ algebra_measure b ≤ algebra_measure c
   ...
   [ALG_MEASURE_ADDITIVE]  Theorem
      ...
      |- ∀b.
           ...
           ∀c.
             ...
             ∀d.
               algebra_canon d ⇒
               (algebra_embed c ∩ algebra_embed d = ∅) ∧
               (algebra_embed b = algebra_embed c ∪ algebra_embed d) ⇒
   ...
   [PROB_BASIC]  Theorem
      ...
      |- (prob ∅ = 0) ∧ (prob 𝕌(:num -> bool) = 1) ∧ ∀b. prob (λs. SHD s ⇔ b) = 1 / 2
   ...
   [PROB_INTER_HALVES]  Theorem
      ...
      |- ∀p.
           measurable p ⇒
           (prob ((λx. SHD x ⇔ T) ∩ p) + prob ((λx. SHD x ⇔ F) ∩ p) = prob p)
   
   [PROB_INTER_SHD]  Theorem
      
      |- ∀b p. measurable p ⇒ (prob ((λx. SHD x ⇔ b) ∩ p o STL) = 1 / 2 * prob p)
   
   [PROB_LE_X]  Theorem
      
      |- ∀s x. (∀s'. measurable s' ∧ s' ⊆ s ⇒ prob s' ≤ x) ⇒ prob s ≤ x
   ...
   [PROB_SUBSET_MONO]  Theorem
      ...
      |- ∀s t. s ⊆ t ⇒ prob s ≤ prob t
   
   [PROB_SUP_EXISTS1]  Theorem
      
      |- ∀s. ∃r b. (algebra_measure b = r) ∧ algebra_embed b ⊆ s
   
   [PROB_SUP_EXISTS2]  Theorem
      
      |- ∀s. ∃z. ∀r. (∃b. (algebra_measure b = r) ∧ algebra_embed b ⊆ s) ⇒ r ≤ z
   
   [X_LE_PROB]  Theorem
      
      |- ∀s x. (∃s'. measurable s' ∧ s' ⊆ s ∧ x ≤ prob s') ⇒ x ≤ prob s
