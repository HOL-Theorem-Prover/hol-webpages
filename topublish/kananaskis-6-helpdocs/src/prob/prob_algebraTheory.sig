...
(*
   ...
   [algebra_embed_def]  Definition
      ...
      |- (algebra_embed [] = ∅) ∧
         ∀h t. algebra_embed (h::t) = alg_embed h ∪ algebra_embed t
   ...
   [ALGEBRA_CANON_UNIV]  Theorem
      ...
      |- ∀l. algebra_canon l ⇒ (algebra_embed l = 𝕌(:num -> bool)) ⇒ (l = [[]])
   
   [ALGEBRA_EMBED_APPEND]  Theorem
      
      |- ∀l1 l2. algebra_embed (l1 ++ l2) = algebra_embed l1 ∪ algebra_embed l2
   
   [ALGEBRA_EMBED_BASIC]  Theorem
      
      |- (algebra_embed [] = ∅) ∧ (algebra_embed [[]] = 𝕌(:num -> bool)) ∧
         ∀b. algebra_embed [[b]] = (λs. SHD s ⇔ b)
   ...
   [ALG_EMBED_BASIC]  Theorem
      ...
      |- (alg_embed [] = 𝕌(:num -> bool)) ∧
         ∀h t. alg_embed (h::t) = (λx. SHD x ⇔ h) ∩ alg_embed t o STL
   ...
   [ALG_EMBED_PREFIX_SUBSET]  Theorem
      ...
      |- ∀b c. alg_embed b ⊆ alg_embed c ⇔ c ≼ b
   
   [ALG_EMBED_TWINS]  Theorem
      
      |- ∀l. alg_embed (SNOC T l) ∪ alg_embed (SNOC F l) = alg_embed l
   
   [COMPL_SHD]  Theorem
      
      |- ∀b. COMPL (λx. SHD x ⇔ b) = (λx. SHD x ⇔ ¬b)
   
   [HALVES_INTER]  Theorem
      
      |- (λx. SHD x ⇔ T) ∩ (λx. SHD x ⇔ F) = ∅
   
   [INTER_STL]  Theorem
      
      |- ∀p q. (p ∩ q) o STL = p o STL ∩ q o STL
   ...
   [MEASURABLE_BASIC]  Theorem
      ...
      |- measurable ∅ ∧ measurable 𝕌(:num -> bool) ∧ ∀b. measurable (λs. SHD s ⇔ b)
   ...
   [MEASURABLE_HALVES]  Theorem
      ...
      |- ∀p q.
           measurable ((λx. SHD x ⇔ T) ∩ p ∪ (λx. SHD x ⇔ F) ∩ q) ⇔
           measurable ((λx. SHD x ⇔ T) ∩ p) ∧ measurable ((λx. SHD x ⇔ F) ∩ q)
   
   [MEASURABLE_INTER]  Theorem
      
      |- ∀s t. measurable s ∧ measurable t ⇒ measurable (s ∩ t)
   
   [MEASURABLE_INTER_HALVES]  Theorem
      
      |- ∀p.
           measurable ((λx. SHD x ⇔ T) ∩ p) ∧ measurable ((λx. SHD x ⇔ F) ∩ p) ⇔
           measurable p
   
   [MEASURABLE_INTER_SHD]  Theorem
      
      |- ∀b p. measurable ((λx. SHD x ⇔ b) ∩ p o STL) ⇔ measurable p
