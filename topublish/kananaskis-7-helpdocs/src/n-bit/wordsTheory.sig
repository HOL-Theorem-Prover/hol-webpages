...
(*
      ...
      |- ∀s t.
           ...
           (let abs_s = if word_msb s then -s else s and
            ...
            in
              if u = 0w then
                u
              else if word_msb s then
                if word_msb t then -u else -u + t
              else if word_msb t then
                u + t
              else
                u)
   ...
   [saturate_mul]  Theorem
      ...
      |- ∀a b.
           saturate_mul a b =
           if FINITE 𝕌(:α) ∧ w2w UINT_MAXw ≤₊ w2w a * w2w b then
             UINT_MAXw
           else
             a * b
   ...
   [word_index_n2w]  Theorem
      ...
      |- ∀n i.
           n2w n ' i ⇔
           if i < dimindex (:α) then
             BIT i n
           else
             FAIL $' index too large (n2w n) i
