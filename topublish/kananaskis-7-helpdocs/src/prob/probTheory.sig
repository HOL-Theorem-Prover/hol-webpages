...
(*
   ...
   [prob_def]  Definition
      ...
      |- ∀s.
           prob s =
           sup (λr. ∃b. (algebra_measure b = r) ∧ algebra_embed b ⊆ s)
   ...
   [PROB_INTER_HALVES]  Theorem
      ...
      |- ∀p.
           measurable p ⇒
           (prob ((λx. SHD x ⇔ T) ∩ p) + prob ((λx. SHD x ⇔ F) ∩ p) =
            prob p)
   ...
   [PROB_INTER_SHD]  Theorem
      ...
      |- ∀b p.
           measurable p ⇒
           (prob ((λx. SHD x ⇔ b) ∩ p o STL) = 1 / 2 * prob p)
   ...
   [PROB_SUP_EXISTS2]  Theorem
      ...
      |- ∀s.
           ∃z.
             ∀r.
               (∃b. (algebra_measure b = r) ∧ algebra_embed b ⊆ s) ⇒ r ≤ z
