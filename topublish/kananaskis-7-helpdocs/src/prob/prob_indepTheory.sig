...
(*
   ...
   [ALG_COVER_TAIL_MEASURABLE]  Theorem
      ...
      |- ∀l.
           alg_cover_set l ⇒
           ∀q.
             measurable (q o (λx. SDROP (LENGTH (alg_cover l x)) x)) ⇔
             measurable q
           ...
           (q o
            (λx.
               SDROP
                 ...
                 x) =
            (λx. SHD x ⇔ T) ∩
            q o (λx. SDROP (LENGTH (alg_cover l1 x)) x) o STL ∪
            (λx. SHD x ⇔ F) ∩
            q o (λx. SDROP (LENGTH (alg_cover l2 x)) x) o STL)
   
   [ALG_COVER_UNIQUE]  Theorem
      
      |- ∀l x s.
           alg_cover_set l ∧ MEM x l ∧ alg_embed x s ⇒ (alg_cover l s = x)
      ...
      |- ∀l.
           ...
           ∀q.
             ...
             ∀x.
               ...
               (prob
                  (alg_embed x ∩
                   q o (λx. SDROP (LENGTH (alg_cover l x)) x)) =
   ...
   [INDEP_SET_DISJOINT_DECOMP]  Theorem
      ...
      |- ∀p q r.
           indep_set p r ∧ indep_set q r ∧ (p ∩ q = ∅) ⇒
           indep_set (p ∪ q) r
