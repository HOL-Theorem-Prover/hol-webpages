...
(*
   ...
   [ALGEBRA_EMBED_APPEND]  Theorem
      ...
      |- ∀l1 l2.
           algebra_embed (l1 ++ l2) = algebra_embed l1 ∪ algebra_embed l2
   ...
   [MEASURABLE_BASIC]  Theorem
      ...
      |- measurable ∅ ∧ measurable 𝕌(:num -> bool) ∧
   ...
   [MEASURABLE_HALVES]  Theorem
      ...
      |- ∀p q.
           ...
           measurable ((λx. SHD x ⇔ T) ∩ p) ∧
           measurable ((λx. SHD x ⇔ F) ∩ q)
   ...
   [MEASURABLE_INTER_HALVES]  Theorem
      ...
      |- ∀p.
           measurable ((λx. SHD x ⇔ T) ∩ p) ∧
           measurable ((λx. SHD x ⇔ F) ∩ p) ⇔ measurable p
